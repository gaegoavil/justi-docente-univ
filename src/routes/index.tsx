    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative min-h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroCampus} alt="Campus universitario" className="w-full h-full object-cover" width={1920} height={1080} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 w-full">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-primary-foreground/85 mb-8 leading-relaxed font-[family-name:var(--font-body)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => (
              ...
              >
                ...
                <p className="text-sm text-muted-foreground font-[family-name:var(--font-body)]">{f.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 overflow-hidden">
        <div className="absolute inset-0">
          <img src={classroomImg} alt="Aula universitaria" className="w-full h-full object-cover" loading="lazy" width={1280} height={720} />
          <div className="absolute inset-0 hero-gradient" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8 font-[family-name:var(--font-body)]">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex gap-3 items-start">
                    ...
                    <span className="text-foreground/80 font-[family-name:var(--font-body)]">{text}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-card rounded-lg border overflow-hidden">
                <button
                  className="w-full flex items-center justify-between px-6 py-4 text-left font-semibold text-foreground hover:bg-muted/50 transition-colors font-[family-name:var(--font-body)]"
                ...
                {openFaq === i && (
                  <div className="px-6 pb-4 text-muted-foreground text-sm leading-relaxed font-[family-name:var(--font-body)]">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 font-[family-name:var(--font-body)]">
